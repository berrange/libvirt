...
typedef enum {
    VIR_NETWORK_PORT_TYPE_BRIDGE,
    VIR_NETWORK_PORT_TYPE_DIRECT,
    VIR_NETWORK_PORT_TYPE_HOSTDEV_PCI,

    VIR_NETWORK_PORT_TYPE_LAST,
} virNetworkPortType;

VIR_ENUM_DECL(virNetworkPort)
